...
# Source the SHADOWHIVE logo for dashboard.
image = 'assets/images/shadowhive-logo-white.png'
...
app.title = "SHADOWHIVE"
app._favicon = "../assets/images/shadowhive-favicon.ico"
